  ...
  return (
    <section className="flex justify-center items-center py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg text-left text-[#C4C4C4] mb-12 leading-relaxed max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-start bg-[#1c1c1c] p-8 rounded-xl shadow-xl transition-all hover:shadow-2xl hover:bg-[#242424]">
            <img src="graph_con.png" alt="Graph Icon" className="mb-4 w-12 h-12 filter drop-shadow(0 0 10px rgba(165, 228, 4, 0.5))"/>
          ...
          {/* Health and Wellness */}
          <div className="flex flex-col items-start bg-[#1c1c1c] p-8 rounded-xl shadow-xl transition-all hover:shadow-2xl hover:bg-[#242424]">
            <img src="light.png" alt="Health and Wellness Icon" className="mb-4 w-12 h-12 filter drop-shadow(0 0 10px rgba(165, 228, 4, 0.5))"/>
            <h3 className="text-2xl font-bold text-white mb-4">
              Health and Wellness
            </h3>
            <p className="text-[#C4C4C4] leading-relaxed">
          ...
          {/* Retirement Planning */}
          <div className="flex flex-col items-start bg-[#1c1c1c] p-8 rounded-xl shadow-xl transition-all hover:shadow-2xl hover:bg-[#242424]">
            <img src="bag.png" alt="Retirement Planning Icon" className="mb-4 w-12 h-12 filter drop-shadow(0 0 10px rgba(165, 228, 4, 0.5))"/>
            <h3 className="text-2xl font-bold text-white mb-4">
              Retirement Planning
            </h3>
            <p className="text-[#C4C4C4] leading-relaxed">
          ...
          {/* Work-Life Balance */}
          <div className="flex flex-col items-start bg-[#1c1c1c] p-8 rounded-xl shadow-xl transition-all hover:shadow-2xl hover:bg-[#242424]">
            <img src="folders.png" alt="Work-Life Balance Icon" className="mb-4 w-12 h-12 filter drop-shadow(0 0 10px rgba(165, 228, 4, 0.5))"/>
            <h3 className="text-2xl font-bold text-white mb-4">
              Work-Life Balance
            </h3>
            <p className="text-[#C4C4C4] leading-relaxed">
